...
@Module({
  ...
  controllers: [AiController, AuthController, AutomationController, ConversationController, HealthController, McpController, MemoryController, PersonaController, PluginController, SkillController, ToolController],
  providers: [AuthService, BootstrapAdminService, ConversationMessageLifecycleService, ConversationMessagePlanningService, ConversationTaskService, JwtAuthGuard, RequestAuthService],
})
